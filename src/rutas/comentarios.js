import { creaComentario } from "../servicios/comentariosServicio.js";
  ...
  app.post(
    ...
    [
      ...
      body("texto")
        ...
        .isLength({ max: 500 })
        .withMessage("El comentario es demasiado largo")
    ...
    async (req, res) => {
      ...
      try {
        ...
        // 3. Lógica de negocio
        const nuevoComentario = await creaComentario(texto, puntuacion);
